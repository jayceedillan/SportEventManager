...
using SportEventManager.Application.Features.Events.Commands.DeleteEvent;
using SportEventManager.Application.Features.Events.Commands.UpdateEvent;
using SportEventManager.Application.Features.Events.Queries.GetAllEvent;
using SportEventManager.Application.Features.Events.Queries.GetEventById;
...
namespace SportEventManager.Controllers
{
    ...
    public class EventController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create(
            ...
            CancellationToken cancellationToken)
        {
            _logger.LogInformation("Creating new Event: {@Command}", command);
        ...
        /// <summary>
        /// Retrieves all event  with optional filtering and pagination
        /// </summary>
            ...
            CancellationToken cancellationToken)
        {
            ...
            var query = new GetAllEventQuery(filter);
            var result = await _mediator.Send(query, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation("Updating event with ID {Id}: {@Command}", id, command);
